...
#model bulding
RidgeRegModel = Ridge(alpha=0.001,copy_X=True)
RidgeRegModel.fit(X_train,y_train)


#Calculating Details
print('Ridge Regression Train Score is : ' , RidgeRegModel.score(X_train, y_train))
print('Ridge Regression Test Score is : ' , RidgeRegModel.score(X_valid, y_valid))
print("----------------------------------------------------------------------")

#predict
y_pred = RidgeRegModel.predict(X_test)
