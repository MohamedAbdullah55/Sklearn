...
#model bulding
SGDRRegModel = SGDRegressor(alpha=0.01,random_state=55,penalty='l1',loss = 'squared_loss')
SGDRRegModel.fit(X_train,y_train)


#Calculating Details
print('SGDRegressor Regression Train Score is : ' , SGDRRegModel.score(X_train, y_train))
print('SGDRegressor Regression Test Score is : ' , SGDRRegModel.score(X_valid, y_valid))
print("----------------------------------------------------------------------")

#predict
y_pred = SGDRRegModel.predict(X_test)
