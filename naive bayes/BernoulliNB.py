...
#model bulding
bernoulli_nb_model = BernoulliNB(alpha=1.0)
bernoulli_nb_model.fit(X_train,y_train)
y_train_pred = bernoulli_nb_model.predict(X_train)
y_test_pred  = bernoulli_nb_model.predict(X_test)

print("score of train \n",bernoulli_nb_model.score(X_train, y_train))
print("score of test \n",bernoulli_nb_model.score(X_test, y_test))
