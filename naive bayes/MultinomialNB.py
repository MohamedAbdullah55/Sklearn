...
#model bulding
multinomial_nb_model = MultinomialNB(alpha=0.5)
multinomial_nb_model.fit(X_train,y_train)
y_train_pred = multinomial_nb_model.predict(X_train)
y_test_pred  = multinomial_nb_model.predict(X_test)

print("score of train \n",multinomial_nb_model.score(X_train, y_train))
print("score of test \n",multinomial_nb_model.score(X_test, y_test))
